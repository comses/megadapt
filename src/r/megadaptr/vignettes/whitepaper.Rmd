...
scp megadapt.sif <server>:<path>
```


```bash
# Build the grid search
./megadapt.sif --db-condig db-postgres.json grid setup --experiment-config grid.json --study-area megadapt_wgs84_v5.gpkg
# Run the grid search
condor_submit climate_budget_reps.sub
