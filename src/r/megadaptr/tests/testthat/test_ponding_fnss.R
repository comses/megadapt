...
describe('a ponding delta method fnss', {
  ...
  it('should decrease if capacity increases', {
    ...
    expect_gt(ponding_fnss_df$ponding_index, ponding_fnss_high_cap_df$ponding_index)
  })
  ...
  it('should increase if precipitation increases', {
    ...
    expect_lt(ponding_fnss_df$ponding_index, ponding_fnss_high_precip_df$ponding_index)
  })
  ...
  it('should increase if runoff increases', {
    ...
    expect_lt(ponding_fnss_df$ponding_index, ponding_fnss_high_runoff_df$ponding_index)
  })
})
