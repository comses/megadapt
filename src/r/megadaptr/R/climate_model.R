...
update_climate <- function(study_data, climate_scenario) {
  ...
  tibble::tibble(
    pk=study_data$ageb_id,
    yearly_precipitation_volume_m3=sampled_rain_runoff_scenario$prec[match_values],
    yearly_runoff_volume_m3=sampled_rain_runoff_scenario$runoff[match_values]
  )
}
