...
#######################################################################################################           
           tabPanel(tags$h2("Introduction"),
                    ...
                    dashboardBody(
                      tabItems(
                        tabItem(tabName = "intro_megadapt",
                         fluidPage(
                        ...
                        tabItem(tabName = "flow_diag",
                                fluidPage(
                                  box(img(src="diagram_model.png",
                                      height=700, 
                                      width=900,
...
#######################################################################################################
           tabPanel(tags$h2("Socio-Institutional Module"),
                    dashboardPage(
...
#######################################################################################################           
           tabPanel(tags$h2("Site selection"),
                     dashboardPage( 
                       dashboardHeader(),
                     dashboardSidebar(
                       sliderInput(inputId="budget", label="Presupuesto",
                                   min = 240, max = 2400,
                                   value = 750),
...
#######################################################################################################           
           tabPanel(tags$h2("Results"),
                    dashboardPage(
                      dashboardHeader(),
                      dashboardSidebar(
                        selectInput("Resultado_pick", "Scale:",
